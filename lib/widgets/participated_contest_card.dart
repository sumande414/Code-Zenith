            ...
            if (snapshot.hasData) {
              ...
              if (contests.isNotEmpty) {
                var performance = metric
                    .calulateHighestAndLowestRatingChangeContest(contests);
                                  ...
                                  children: [
                                    Card(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          "Hi ${((widget.username??"").indexOf(' '))==-1?widget.username:(widget.username ?? "").substring(0, (widget.username ?? " ").indexOf(' '))}! Here are the results of the contests you participated in:",
                                              ...
                                              Text(
                                                  ...
                                                  style: TextStyle(
                                                      ...
                                                      fontWeight:
                                                          FontWeight.bold)),
                                              Text(
                                                "Contest with best performance: ${performance['highest_contest_name']} (Rating change of ${performance['highest']})\nContest with worst performance: ${performance['lowest_contest_name']}(Rating change of ${performance['lowest']})",
                ...
                return Center(child:Text(
                    "No data to display. Participate in atleast a few contests to get some statistics",textAlign: TextAlign.center,style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 15,
                                                    fontWeight:
                                                        FontWeight.bold)));
